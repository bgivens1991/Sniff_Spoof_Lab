...
This is the code I used to sniff and spoof packets between two VMs from a another Attacker VM.  Also included is my report walkthrough the steps I did to executed these objectives.
